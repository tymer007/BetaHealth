  ...
  return (
    <div className="min-h-screeen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-full bg-white flex justify-center">
        ...
        <Link to="/"><img src="./images/logo.png" alt="Logo" className="h-20 w-auto mb-8 mx-auto pt-2" /></Link>
        <form onSubmit={handleSubmit} className="space-y-6">
          
          <div className="  mb-4">
            <Link to="/"><a  className="text-blue-500 hover:underline text-left">Back Home</a></Link>
          ...
          <Link to="/SignUpExpert2"><button type="submit" className="bg-orange-600 text-white px-6 py-3 rounded hover:bg-orange-700 w-full">
            Continue
          </button></Link>
          <p className="text-center mt-4 pb-3">
            <Link to="/LoginExpert"><a href="#" className="text-blue-500 hover:underline">Already have an expert account?</a></Link>
          </p>
        </form>
        </div>
      </div>
