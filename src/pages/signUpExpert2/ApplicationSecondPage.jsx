    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-full bg-white flex justify-center">
        <div className="w-full max-w-2xl">
          ...
          <img src="./images/logo.png" alt="Logo" className="h-20 w-auto mb-8 mx-auto" />
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" onClick={buttonAct} className="bg-orange-600 text-white px-6 py-3 rounded hover:bg-orange-700 w-full">
              Submit
            </button>
